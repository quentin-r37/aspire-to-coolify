...
export function isApplicationChain(chain) {
    return chain.rootMethod in APPLICATION_METHODS;
}
export function extractApplication(chain) {
...
function extractEnvironment(args, rawArgs) {
    if (args.length < 2) {
...
function extractReferenceTarget(arg) {
    if (!arg)
        return null;
